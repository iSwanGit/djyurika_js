...
client.on('message', async message => {
  ...
  if (message.content.startsWith(`${environment.prefix}p`)) {
    execute(message, serverQueue);
    return;
  } else if (message.content.startsWith(`${environment.prefix}s`)) {
    skip(message, serverQueue);
    return;
  } else if (message.content.startsWith(`${environment.prefix}l`)) {
